...
<body>
	<div>
		...
		$sql = "SELECT CONCAT(absolutepath,CASE WHEN relativepath IS NULL THEN '' ELSE relativepath END, filename) as 'absDir' from fanart WHERE filetype != 'webm' AND filetype != 'mp4'";
